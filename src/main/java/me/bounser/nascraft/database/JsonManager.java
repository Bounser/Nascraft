...
public class JsonManager {
    ...
    public static JsonManager getInstance() { return instance == null ? instance = new JsonManager() : instance; }

    public void setupFiles(@NotNull List<Category> categories) {

        int days = Data.getDay();
