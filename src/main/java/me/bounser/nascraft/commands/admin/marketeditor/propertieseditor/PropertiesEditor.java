        ...
        for (Category category : categories) {
            ...
            for (int k = 1; k <= 8; k++) {
                ...
                if (item == null) {
                    ...
                    meta.setLore(Arrays.asList(
                            ChatColor.GRAY + "Initial price: " + ChatColor.GREEN + Formatter.format(item.getCurrency(), item.getPrice().getInitialValue(), Style.ROUND_BASIC),
                            ...
                            ChatColor.GRAY + "Support: " + ChatColor.GREEN + item.getPrice().getSupport(),
                            ChatColor.GRAY + "Resistance: " + ChatColor.GREEN + item.getPrice().getResistance(),
                            " ",
                            ChatColor.GREEN + "§lCLICK TO EDIT"
                    ));
